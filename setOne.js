...
// CODE HERE
let cupCake = (par1, par2) => console.log(`The first parameter is ${par1}. The second parameter is ${par2}`)

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.

return("Vanilla Cup Cake", "Chocolate Cup Cake")
...
Then, outside of the greeting function, invoke the greeting function, passing in the value firstName and lastName of your choice, and a callback function that takes a parameter of fullName. The callback function will print ç. 
*/
...
// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
greeting('Asel', 'Orozaly', (fullName) => console.log(`Hello, my full name is ${fullName}`));
